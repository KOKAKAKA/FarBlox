...
local is_Mobile = user_input.TouchEnabled
...
function nurysium:open()
	...
	-- New element animations
	local gradient_animation = Instance.new("UIGradient")
	gradient_animation.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 0)),
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 255, 0)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 0, 255))
	}
	gradient_animation.Parent = ui.Background

	tween_service:Create(gradient_animation, TweenInfo.new(2.5, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1), {
		Rotation = 360
	}):Play()
...
function nurysium:init(name: string, is_draggable: boolean, parent)
	...
	-- [Rest of the code initializing UI elements]
...
function nurysium: create_toggle(name: string, section_name: string, callback)
	...
	-- Add hover animation for the visibility button
	uiVisible.MouseEnter:Connect(function()
		tween_service:Create(uiVisible, TweenInfo.new(0.3, Enum.EasingStyle.Exponential, Enum.EasingDirection.InOut), {
			Size = UDim2.new(0, 60, 0, 60),
			BackgroundTransparency = 0.8
		}):Play()
	end)

	uiVisible.MouseLeave:Connect(function()
		tween_service:Create(uiVisible, TweenInfo.new(0.3, Enum.EasingStyle.Exponential, Enum.EasingDirection.InOut), {
	...
	-- Final tween effect to add an animated bounce
	tween_service:Create(uiVisible, TweenInfo.new(1.5, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out), {
		Position = UDim2.new(0.045, 0, 0.863, 0)
	}):Play()
end
